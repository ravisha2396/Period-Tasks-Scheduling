...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x60000000 + 0x0), LENGTH = (65536*1K - 0x0)
    SRAM (wx) : ORIGIN = 0x80000000, LENGTH = (32768 * 1K)
    ...
    IDT_LIST (wx) : ORIGIN = (0x80000000 + (32768 * 1K)), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(".kernel_noinit.*")
 ...
 __dtcm_end = .;
 __dtcm_data_rom_start = LOADADDR(.dtcm_data);
